      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4 main__title"  data-aos="fade-up">
              Landing template for startups
            </h1>
            <p className="text-xl text-gray-400 mb-8 main__deascription" data-aos="fade-up" data-aos-delay="200">
              Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn main__start-btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">
                  Start free trial
                </a>
              </div>
